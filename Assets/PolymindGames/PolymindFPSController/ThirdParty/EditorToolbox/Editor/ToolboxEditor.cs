...
namespace Toolbox.Editor
{
    ...
    public class ToolboxEditor : Editor
    {
        ...
        /// </summary>
        public void IgnoreProperty(SerializedProperty property) => IgnoreProperty(property.propertyPath);
        public void RemoveIgnore(SerializedProperty property) => RemoveIgnore(property.propertyPath);
        ...
        public void RemoveIgnore(string propertyPath) => propertiesToIgnore.Remove(propertyPath);
