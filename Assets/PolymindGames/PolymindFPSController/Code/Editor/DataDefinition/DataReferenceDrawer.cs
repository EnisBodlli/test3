...
namespace PolymindGames.InventorySystem
{
    ...
    public class DataReferenceDrawer : PropertyDrawerBase
    {
        ...
        private DataReferenceDetailsAttribute m_DataDetails;
        private DataReferenceDetailsAttribute DataDetails
        {
            get
            {
                if (m_DataDetails == null)
                    m_DataDetails = PropertyUtility.GetAttribute<DataReferenceDetailsAttribute>(m_Property);
