...
namespace PolymindGames.MovementSystem
{
    ...
    public sealed class CharacterControllerMotor : NetworkBehaviour, ICharacterMotor, ISaveableComponent
    {
        public float CCSpeed => m_CController.velocity.magnitude;
        ...
        private void Update()
        {
            ...
            if (!m_CController.enabled || m_MovementController == null)
                return;
            ...
            m_SimulatedVelocity = m_MovementController.GetMotionInput(m_SimulatedVelocity, out m_ApplyGravity, out m_SnapToGround);
