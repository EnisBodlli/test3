...
namespace PolymindGames
{
    ...
    public class Character : NetworkBehaviour, ICharacter
    {
        ...
        [SerializeField] private ThirdPersonPlayer m_TpsPlayer;

        public void StateEnterCallback(MovementStateType state)
        {
            if (isLocalPlayer == false) return;

            if(state == MovementStateType.Slide)
            {
                m_TpsPlayer.PlaySlideAnimation();
            }
        }
