...
namespace PolymindGames.ResourceGathering
{
    ...
    public class Gatherable : NetworkBehaviour, IGatherable, ISaveableComponent
    {
        ...
        public void HandleDamageCmd(float damage, DamageContext context)
        {
            HandleDamage(damage, context);
        }
        ...
        [ClientRpc]
        public void RpcHitEffects(DamageContext dmgContext)
        {
        ...
        [TargetRpc]
        public void RpcTargetHitEffects(NetworkConnectionToClient target, DamageContext dmgContext)
        {
            m_BaseVisuals.SetActive(false);
        ...
        [ClientRpc]
        public void RpcDestroyTree(DamageContext dmgContext)
        {
