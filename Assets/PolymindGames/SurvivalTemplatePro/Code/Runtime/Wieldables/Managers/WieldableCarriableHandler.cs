...
namespace PolymindGames.WieldableSystem
{
    public sealed class WieldableCarriableHandler : CharacterBehaviour, IWieldableCarriableHandler, ISaveableComponent
    {
        ...
        [SerializeField]private List<CarriableWieldableInfo> m_CarriablesDef = new List<CarriableWieldableInfo>();
        ...
        protected override void OnBehaviourEnabled()
        {
            ...
            foreach (CarriableWieldableInfo t in m_CarriablesDef)
            {
                SpawnCarriableWithId(t.carriableDef, t.carriableWieldable);
            }
        ...
        private ICarriable SpawnCarriableWithId(DataIdReference<CarriableDefinition> carriableDef, Wieldable wieldable)
        {
            var carriable = m_WieldablesController.AddWieldable(wieldable, false, true) as ICarriable;
            m_InSceneCarriables.Add(carriableDef, carriable);
            carriable.InitializeCarriable(carriableDef, m_CarriableDropper);
            carriable.SetVisibility(false);
    ...
    [System.Serializable]
    public class CarriableWieldableInfo
    {
        public DataIdReference<CarriableDefinition> carriableDef;
        public Wieldable carriableWieldable;
