...
namespace PolymindGames.WorldManagement
{
    ...
    public sealed class WorldManager : WorldManagerBase, ISaveableComponent
    {
        ...
        [SyncVar]private float m_NormalizedTime;
        ...
        private void UpdateTime()
        {
            ...
            TimeSettings timeSettingsTemp = m_Time;

            timeSettingsTemp.Hour = (int)(m_NormalizedTime * 24);
            timeSettingsTemp.Minute = (int)((m_NormalizedTime * 24 - m_Time.Hour) * 60);
            timeSettingsTemp.Second = (int)((((m_NormalizedTime * 24 - m_Time.Hour) * 60) - m_Time.Minute) * 60);

            m_Time = timeSettingsTemp;
        }
