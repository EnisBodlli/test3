...
namespace PolymindGames.BuildingSystem
{
    public class Socket : MonoBehaviour
    {
        ...
        public bool OccupySpaces(DataIdReference<BuildableCategoryDefinition>[] spacesToOccupy)
        {
            if (!m_OccupiedSpaces.ContainsAnyDef(spacesToOccupy))
            {
                m_OccupiedSpaces.AddRange(spacesToOccupy);
                return true;
            }
